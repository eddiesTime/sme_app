...
class _$WeatherSourceTearOff {
  ...
  _WeatherSource call({int crawlRate, String title, String slug, String url}) {
...
abstract class $WeatherSourceCopyWith<$Res> {
  ...
  $Res call({int crawlRate, String title, String slug, String url});
}
...
class _$_WeatherSource with DiagnosticableTreeMixin implements _WeatherSource {
  const _$_WeatherSource({this.crawlRate, this.title, this.slug, this.url});
