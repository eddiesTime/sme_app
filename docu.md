...
:closed\_book: State Whatever data you need in order to rebuild your UI
...
*Figure 34: Image taken from the Google I/O 2018
...
In States Rebuilder the model is usually named store. Therefore in the
example the model for weather related functionality is called
`WeatherStore`.
...
a notification to its Observers.

##### Presentation Layer

To access the WeatherStore in the application it needs to be injected
...
registered as the only observable with the parameter `models`. Therefore
the UI gets rebuild whenever StateBuilder receives a notification from
WeatherStore. Inside the `builder` parameter the attribute
`whenConnectionState` of `reactiveModel` (in this case the Reactive
Model registered in `models`) is used to handle different connections
states, e.g. `isIdle`, and build the corresponding UI.
...
pattern with a simplified API and less overhead to worry about.
...
criteria which I will further explain in the upcoming section.

The quality attributes are taken from "Characterizing Architecturally
Significant Requirements" by Chen et
al.:[[@chenCharacterizingArchitecturallySignificant2013]](http://ieeexplore.ieee.org/document/6365165/)
...
Maintainability is defined as "the ease with which a software system or
component can be modified to correct faults, improve performance or
other attributes, or adapt to a changed environment."
[[@159342]](https://ieeexplore.ieee.org/document/159342) To put it in
simpler terms: The state management solution implementation is evaluated
based on changes to improve the application and their affect on other
components.
...
[[@159342]](https://ieeexplore.ieee.org/document/159342) For our
evaluation the focus is on the functional capacity part. How easy is it
to add more feature with the state management solution?
...
[[@159342]](https://ieeexplore.ieee.org/document/159342) This criteria
will be similar rated as maintainability since they modularity impacts
the other quality attribute criteria.
...
software system"
[[@159342]](https://ieeexplore.ieee.org/document/159342) For the
evaluation reusability will be evaluated by the reusability of the state
management solution in non-Flutter applications.
...
[[@159342]](https://ieeexplore.ieee.org/document/159342) This criteria
will be evaluated based on the simplicity to write unit tests.

------------------------------------------------------------------------

#### Synergy

Synergy in the context of the evaluation is defined as how well the
state management solution fits into the architecture and how well it
interacts with the other packages used to develop the application.

#### Time to learn

Time to learn in the context of the evaluation is defined as the time it
takes the developer to learn the concepts of the state management
solution and implement them successfully in an example application. This
criteria is based on my own time it took me to learn enough about the
state management solution to implement it.

#### Sources

Sources in the context of the evaluation is defined as the amount of
...
a documentation and how well the documentation is written.
...
Side-effect-handling in the context of the evaluation is defined as how
well the SMS handles side-effects. To be more precise does the SMS
provide a recommendation or guideline how to handle side-effects, how
easy can it be implemented and how well it works.

#### Debugging

Debugging in the context of the evaluation is defined as how easy can
bugs be debug with the SMS. To be more precise how difficult is it to
...
Criteria Stateful ChangeNotifierProvider Bloc MobX States Redux Widget
Rebuilder
...
-   Bloc: Has the package bloc\_test
    [[@BlocTestDart]](https://pub.dev/packages/bloc_test) which makes it
    easier to write tests for blocs.
...
-   Bloc: Bloclibrary [[@Bloc]](https://bloclibrary.dev/#/) is one of
    the best documentations I have seen so far. It contains multiple
...
Side-effect 1 1 3 2 3 2 handling
...
Example: Stateful widget Small: ChangeNotifierProvider, MobX Medium:
Bloc, MobX, States Rebuilder, Redux Large: Bloc, Redux, States Rebuilder
...
-   which solution is suited to help with state management in example,
    small-scale, middle-scale, large-scale applications

References
----------

\[1\]"Widget class - widgets library - Dart API."
https://api.flutter.dev/flutter/widgets/Widget-class.html (accessed May
03, 2020). \[2\]"Why Bloc? - Bloc." https://bloclibrary.dev/\#/whybloc
(accessed May 12, 2020). \[3\]"Who uses Dart."
https://dart.dev/community/who-uses-dart.html (accessed May 04, 2020).
\[4\]"Weather - Bloc." https://bloclibrary.dev/\#/flutterweathertutorial
(accessed May 06, 2020). \[5\]"updateShouldNotify method -
...
(accessed May 10, 2020). \[6\]"updateRenderObject method -
...
(accessed May 17, 2020). \[7\]"Technical overview."
https://flutter.dev/docs/resources/technical-overview (accessed May 16,
2020). \[8\]"StreamSink class - dart:async library - Dart API."
https://api.dart.dev/stable/2.8.2/dart-async/StreamSink-class.html
(accessed May 12, 2020). \[9\]"StreamController class - dart:async
library - Dart API."
https://api.dart.dev/stable/2.8.1/dart-async/StreamController-class.html
(accessed May 12, 2020). \[10\]"Stream class - dart:async library - Dart
API." https://api.dart.dev/stable/2.8.2/dart-async/Stream-class.html
(accessed May 12, 2020). \[11\]"StreamBuilder class - widgets library -
Dart API."
https://api.flutter.dev/flutter/widgets/StreamBuilder-class.html
(accessed May 12, 2020). \[12\]"Strategic Domain-Driven Design for
Improving Flutter architecture - Majid Hajian \| Flutter Europe -
YouTube." https://www.youtube.com/watch?v=lGv6KV5u75k&t=2260s (accessed
May 07, 2020). \[13\]"States Rebuilder -- ZERO Boilerplate Flutter State
Management," Reso Coder, Dec. 30, 2019.
https://resocoder.com/2019/12/30/states-rebuilder-zero-boilerplate-flutter-state-management/
(accessed May 15, 2020). \[14\]"states\_rebuilder \| Flutter Package,"
Dart packages. https://pub.dev/packages/states\_rebuilder (accessed May
15, 2020). \[15\]"Start thinking declaratively."
https://flutter.dev/docs/development/data-and-backend/state-mgmt/declarative
(accessed May 03, 2020). \[16\]"Simple app state management."
https://flutter.dev/docs/development/data-and-backend/state-mgmt/simple
(accessed May 12, 2020). \[17\]"Separation of Concerns in Software
Design," Alexey Naumov, Jan. 16, 2020.
http://nalexn.github.io/separation-of-concerns/ (accessed May 17, 2020).
\[18\]"rxdart \| Dart Package," Dart packages.
...
(accessed May 03, 2020). \[20\]"redux \| Dart Package," Dart packages.
https://pub.dev/packages/redux (accessed May 12, 2020). \[21\]"Redux."
https://redux.js.org/introduction/three-principles (accessed May 12,
2020). \[22\]"provider \| Flutter Package," Dart packages.
https://pub.dev/packages/provider (accessed May 12, 2020).
\[23\]"programming languages - What is a 'side effect?,'" Software
Engineering Stack Exchange.
https://softwareengineering.stackexchange.com/questions/40297/what-is-a-side-effect
(accessed May 06, 2020). \[24\]Pragmatic State Management in Flutter
(Google I/O'19). . \[25\]"Mutable," MDN Web Docs.
https://developer.mozilla.org/en-US/docs/Glossary/Mutable (accessed May
08, 2020). \[26\]"mobx \| Dart Package," Dart packages.
https://pub.dev/packages/mobx (accessed May 14, 2020).
\[27\]"mobx\_codegen \| Dart Package," Dart packages.
https://pub.dev/packages/mobx\_codegen (accessed May 14, 2020). \[28\]R.
C. Martin, Clean architecture: A craftsman's guide to software structure
and design. Boston, MA: Prentice Hall, 2017. \[29\]D. Mackier, "Flutter
Architecture --- Provider Implementation Guide," Medium, Jun. 19, 2019.
https://medium.com/flutter-community/flutter-architecture-provider-implementation-guide-d33133a9a4e8
(accessed May 12, 2020). \[30\]"List of state management approaches."
https://flutter.dev/docs/development/data-and-backend/state-mgmt/options
(accessed May 03, 2020). \[31\]T. Peierls, B. Goetz, J. Bloch, J.
Bowbeer, D. Lea, and D. Holmes, Java concurrency in practice.
Addison-Wesley Professional, 2005. \[32\]"Introduction of Programming
Paradigms," GeeksforGeeks, Oct. 12, 2018.
https://www.geeksforgeeks.org/introduction-of-programming-paradigms/
(accessed May 03, 2020). \[33\]"Introduction · MobX."
https://mobx.js.org//index.html (accessed May 14, 2020).
\[34\]"Introduction to declarative UI."
https://flutter.dev/docs/get-started/flutter-for/declarative (accessed
May 03, 2020). \[35\]"injectable\_generator \| Dart Package," Dart
packages. https://pub.dev/packages/injectable\_generator (accessed May
17, 2020). \[36\]"injectable \| Dart Package," Dart packages.
https://pub.dev/packages/injectable (accessed May 17, 2020).
\[37\]Inherited Widgets Explained - Flutter Widgets 101 Ep. 3. .
\[38\]"InheritedWidget class - widgets library - Dart API."
https://api.flutter.dev/flutter/widgets/InheritedWidget-class.html
(accessed May 18, 2020). \[39\]A. Hunt and D. Thomas, The Pragmatic
programmer : from journeyman to master. Boston \[etc.\]: Addison-Wesley,
\[40\]How Stateful Widgets Are Used Best - Flutter Widgets 101 Ep.
\[41\]How Flutter renders Widgets. . \[42\]How to Create Stateless
Widgets - Flutter Widgets 101 Ep. 1. . \[43\]hgraca, "Architectural
Styles vs. Architectural Patterns vs. Design Patterns," **???**,
Jul. 28, 2017.
https://herbertograca.com/2017/07/28/architectural-styles-vs-architectural-patterns-vs-design-patterns/
(accessed May 06, 2020). \[44\]"Getting Started with the BLoC Pattern,"
raywenderlich.com.
https://www.raywenderlich.com/4074597-getting-started-with-the-bloc-pattern
(accessed May 12, 2020). \[45\]"get\_it \| Dart Package," Dart packages.
https://pub.dev/packages/get\_it (accessed May 17, 2020). \[46\]E.
Gamma, R. Helm, R. Johnson, and J. M. Vlissides, Design patterns:
Elements of reusable object-oriented software, 1st ed. Addison-Wesley
Professional, 1994. \[47\]"freezed \| Dart Package."
https://pub.dev/packages/freezed (accessed May 17, 2020). \[48\]"Flutter
Tutorial: Pros and Cons of popular State Management Approaches custom,"
Codemagic blog, Nov. 11, 2019.
https://blog.codemagic.io/flutter-tutorial-pros-and-cons-of-state-management-approaches/
(accessed May 10, 2020). \[49\]"flutter\_redux \| Flutter Package," Dart
packages. https://pub.dev/packages/flutter\_redux (accessed May 12,
2020). \[50\]"Flutter MobX Tutorial -- Transparent & Reactive State
...
(accessed May 14, 2020). \[51\]"flutter\_mobx \| Flutter Package," Dart
packages. https://pub.dev/packages/flutter\_mobx (accessed May 14,
2020). \[52\]"Flutter Firebase & DDD Course \[1\] -- Domain-Driven
Design Principles," Reso Coder, Mar. 09, 2020.
https://resocoder.com/2020/03/09/flutter-firebase-ddd-course-1-domain-driven-design-principles/
(accessed May 17, 2020). \[53\]"flutter\_bloc \| Flutter Package."
https://pub.dev/packages/flutter\_bloc (accessed May 06, 2020).
\[54\]"flutter\_bloc - Bloc."
https://bloclibrary.dev/\#/flutterbloccoreconcepts (accessed May 12,
2020). \[55\]"Flutter - Beautiful native apps in record time."
https://flutter.dev/ (accessed May 04, 2020). \[56\]"Flutter
Architecture Samples." http://fluttersamples.com/ (accessed May 06,
2020). \[57\]E. Evans, Domain-driven design : tackling complexity in the
heart of software. Boston: Addison-Wesley, 2004. \[58\]"Element class -
widgets library - Dart API."
https://api.flutter.dev/flutter/widgets/Element-class.html (accessed May
03, 2020). \[59\]"Effective Dart: Documentation."
https://dart.dev/guides/language/effective-dart/documentation (accessed
May 05, 2020). \[60\]"Differentiate between ephemeral state and app
state."
https://flutter.dev/docs/development/data-and-backend/state-mgmt/ephemeral-vs-app
(accessed May 03, 2020). \[61\]"devonfw-forge/devonfw4flutter," GitHub.
https://github.com/devonfw-forge/devonfw4flutter (accessed May 05,
2020). \[62\]"dartz \| Dart Package," Dart packages.
https://pub.dev/packages/dartz (accessed May 17, 2020). \[63\]"dart -
Flutter : Bad state: Stream has already been listened to," Stack
Overflow.
https://stackoverflow.com/questions/51396769/flutter-bad-state-stream-has-already-been-listened-to
(accessed May 12, 2020). \[64\]"createElement method - StatelessWidget
class - widgets library - Dart API."
https://api.flutter.dev/flutter/widgets/StatelessWidget/createElement.html
(accessed May 17, 2020). \[65\]"Core Concepts."
https://mobx.netlify.app/concepts (accessed May 14, 2020).
\[66\]"Consumer class - provider library - Dart API."
https://pub.dev/documentation/provider/latest/provider/Consumer-class.html
(accessed May 12, 2020). \[67\]L. Chen, M. Ali Babar, and B. Nuseibeh,
"Characterizing Architecturally Significant Requirements," IEEE Softw.,
vol. 30, no. 2, pp. 38--45, Mar. 2013, doi: 10.1109/MS.2012.174.
\[68\]"ChangeNotifierProvider class - provider library - Dart API."
https://pub.dev/documentation/provider/latest/provider/ChangeNotifierProvider-class.html
(accessed May 12, 2020). \[69\]"ChangeNotifier class - foundation
library - Dart API."
https://api.flutter.dev/flutter/foundation/ChangeNotifier-class.html
(accessed May 12, 2020). \[70\]"canUpdate method - Widget class -
widgets library - Dart API."
https://api.flutter.dev/flutter/widgets/Widget/canUpdate.html (accessed
May 17, 2020). \[71\]"build\_runner \| Dart Package," Dart packages.
https://pub.dev/packages/build\_runner (accessed May 17, 2020).
\[72\]Build reactive mobile apps with Flutter (Google I/O '18). .
\[73\]"BuildContext class - widgets library - Dart API."
https://api.flutter.dev/flutter/widgets/BuildContext-class.html
(accessed May 03, 2020).
\[74\]"brianegan/flutter\_architecture\_samples," GitHub.
https://github.com/brianegan/flutter\_architecture\_samples (accessed
May 12, 2020). \[75\]D. Boelens, "Flutter - Reactive Programming -
Streams - BLoC," Didier Boelens.
https://www.didierboelens.com/2018/08/reactive-programming-streams-bloc/
(accessed May 12, 2020). \[76\]"bloc\_test \| Dart Package," Dart
packages. https://pub.dev/packages/bloc\_test (accessed May 16, 2020).
\[77\]"bloc library - Dart API."
https://pub.dev/documentation/bloc/latest/bloc/bloc-library.html
(accessed May 08, 2020). \[78\]"bloc \| Dart Package," Dart packages.
https://pub.dev/packages/bloc (accessed May 16, 2020). \[79\]"bloc -
Bloc." https://bloclibrary.dev/\#/coreconcepts (accessed May 12, 2020).
\[80\]"Bloc." https://bloclibrary.dev/\#/ (accessed May 06, 2020).
\[81\]"bliki: LocalDTO," martinfowler.com.
https://martinfowler.com/bliki/LocalDTO.html (accessed May 17, 2020).
\[82\]"BehaviorSubject class - rx library - Dart API."
https://pub.dev/documentation/rxdart/latest/rx/BehaviorSubject-class.html
(accessed May 12, 2020). \[83\]"AsyncSnapshot class - widgets library -
Dart API."
https://api.flutter.dev/flutter/widgets/AsyncSnapshot-class.html
(accessed May 12, 2020). \[84\]"Asynchronous programming: streams."
https://dart.dev/tutorials/language/streams (accessed May 12, 2020).
\[85\]"IEEE standard glossary of software engineering terminology," IEEE
Std 610.12-1990, pp. 1--84, 1990. \[86\]V. Vernon, Domain-driven design
distilled, 1st ed. Addison-Wesley Professional, 2016. \[87\]J. W. Lloyd,
"Declarative programming in escher," University of Bristol, GBR, 1995.
